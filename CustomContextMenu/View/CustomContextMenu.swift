...
//    list of action..
    var menu: UIMenu
    var onEnd : ()-> ()
    init(@ViewBuilder content : @escaping ()-> Content,@ViewBuilder preview : @escaping ()-> Preview, action: @escaping ()-> UIMenu,onEnd: @escaping ()->()){
...
//        setting our content viw as main Interaction view..
